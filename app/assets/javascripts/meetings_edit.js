...
(function () {
  ...
  angular.module('meetingModule', ['ui.bootstrap', 'confirm.click', 'ng-rails-csrf', 'validation.optionCheck', 'fileCheck', 'extension.button', 'ngSanitize', 'agendacontent.to.hiddeninput'])
